...
#define kWBSDKDemoAppKey @"760887935"

#define kWBSDKDemoAppSecret @"94062e776de9d89531357472571b1ab5"
...
- (void)viewDidLoad
{
    ...
    [logInBtnOAuth setFrame:CGRectMake(85, 120, 200, 40)];
    [logInBtnOAuth setTitle:@"微博登陆" forState:UIControlStateNormal];
