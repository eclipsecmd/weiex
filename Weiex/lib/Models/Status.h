...
@interface Status : NSObject {
    ...
    NSString*       relativeLocation;//相对位置,东八区
    long long       relativeDistance;//relative distace
    
    long long       starAmount; //微博加星数
    long long       viewAmount; //微博点击查看数
}
...
@property (nonatomic, retain) NSString*       relativeLocation;
@property (nonatomic, assign) long long       relativeDistance;

@property (nonatomic, assign) BOOL            unread;
@property (nonatomic, assign) BOOL            hasReply;

@property (nonatomic,assign)  long long       starAmount;
@property (nonatomic,assign)  long long       viewAmount;
...
- (Status*)initWithJsonDictionary:(NSDictionary*)dic MyRegion:(MKCoordinateRegion)region;
